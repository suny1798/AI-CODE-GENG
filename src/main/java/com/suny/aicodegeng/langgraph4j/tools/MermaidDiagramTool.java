package com.suny.aicodegeng.langgraph4j.tools;
...
import com.suny.aicodegeng.langgraph4j.model.enums.ImageCategoryEnum;
import com.suny.aicodegeng.manage.CosManager;
...
public class MermaidDiagramTool {
    ...
    public List<ImageResource> generateMermaidDiagram(@P("Mermaid 图表代码") String mermaidCode,
        ...
        try {
            ...
            // 上传到COS
            String keyName = String.format("/codeGeng/mermaid/%s/%s",
