package com.suny.aicodegeng.core.handler;

import cn.hutool.core.io.FileUtil;
import cn.hutool.core.util.StrUtil;
import cn.hutool.json.JSONObject;
import cn.hutool.json.JSONUtil;
import com.suny.aicodegeng.ai.model.message.*;
import com.suny.aicodegeng.ai.tools.BaseTool;
import com.suny.aicodegeng.ai.tools.ToolManager;
...
//                    vueProjectBuilder.buildProjectAsync(projectPath);
    ...
    private String handleJsonMessageChunk(String chunk, StringBuilder chatHistoryStringBuilder, Set<String> seenToolIds) {
        ...
        switch (typeEnum) {
            ...
            case TOOL_REQUEST -> {
                ToolRequestMessage toolExecutedMessage = JSONUtil.toBean(chunk, ToolRequestMessage.class);
